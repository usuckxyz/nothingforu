...
local MainUIColor = COL3RGB(0, 231, 254)    
...
function library:New(name)      
	...
	Menu.Image = "http://www.roblox.com/asset/?id=6880496154"      
...
do 
    ...
    UIGradient_5.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 90, 90))}
...
function keybindadd(text)
	...
	TextLabel.Text = name      
	TextLabel.TextColor3 = COL3RGB(0, 200, 255)      
	TextLabel.TextSize = 15.000      
	TextLabel.TextXAlignment = Enum.TextXAlignment.Left      

	TabButtons.Name = "TabButtons"      
	TabButtons.Parent = Menu      
	TabButtons.BackgroundColor3 = COL3RGB(0, 200, 255)      
...
local gui = library:New("fluid.xyz")      
...
aimbot:Element("Dropdown", "prediction type", {options = {"off", "fluidxyz", "bloxsense.gay", "ova.rocks", "nixus"}}) 
...
client:Element("Toggle", "Watermark", nil, function()  
  if WatermarkToggle == false then
    ...
    Text.Text = "fluid.xyz| Alpha | fps | 1"
    Text.TextColor3 = Color3.fromRGB(65025, 65025, 65025)
    Text.TextSize = 14.000
    Text.TextStrokeTransparency = 0.000
